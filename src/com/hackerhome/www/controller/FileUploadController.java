...
public class FileUploadController {  
    ...
    public String addUser(@RequestParam("id") String id, @RequestParam MultipartFile[] myfiles, HttpServletRequest request, HttpServletResponse response) throws IOException{  
        //可以在上传文件的同时接收其它参数  
